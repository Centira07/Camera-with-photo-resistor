...
int A = 4; // Corresponds to a 0b001 binary for most of the multiplexer
int B = 5; // Corresponds to a 0b010 binary for most of the multiplexer
int C = 6; // Corresponds to a 0b100 binary for most of the multiplexer
